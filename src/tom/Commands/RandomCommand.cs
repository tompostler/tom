...
namespace Unlimitedinf.Tom.Commands
{
    ...
    internal static class RandomCommand
    {
        public static Command Create()
        {
            ...
            Argument<RandomType> randomTypeArg = new(
                "type",
        ...
        private static void Handle(RandomType type) => Console.WriteLine(InnerHandle(type));

        public static string InnerHandle(RandomType type)
        {
